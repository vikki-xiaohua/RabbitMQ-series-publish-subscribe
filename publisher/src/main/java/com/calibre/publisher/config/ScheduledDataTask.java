...
public class ScheduledDataTask {
    ...
    @Autowired
    public ScheduledDataTask(IFxCurrencyRateService fxCurrencyRateService, IEmailService emailService,
    ...
    public void scheduleTaskWithFixedRate() {
        try {
            currencyPairList = env.getProperty(Constants.FOREX_ENDPOINT_CURRENCY_PAIR_LIST, List.class);
            ...
            for (String currencyPair : currencyPairList) {
                fxCurrencyRateService.getFxRateListAndSend(currencyPair, toSendList);
            }
